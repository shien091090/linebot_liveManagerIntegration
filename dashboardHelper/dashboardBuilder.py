...
.weather-card-today .weather-card-header { background: #DBEAFE; }
.weather-card-header {
    display: flex; align-items: baseline; gap: 8px;
    padding: 10px 14px 8px; background: #F8FAFC;
    border-bottom: 1px solid #E2E8F0;
}
.weather-day-main { font-size: 15px; font-weight: 700; color: #1E293B; }
.weather-day-sub { font-size: 12px; color: #64748B; }
.weather-slots {
    display: flex;
}
.weather-slot {
...
.weather-slot:last-child { border-right: none; }
.slot-period { font-size: 12px; font-weight: 600; color: #475569; }
